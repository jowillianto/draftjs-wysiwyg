...
export function Link(props) {
    ...
    return (_jsx("a", __assign({ href: url }, { children: linkTest || props.children })));
}
/*
  Image
*/
export function Image(props) {
    ...
    return (_jsxs(React.Fragment, { children: [_jsx("img", { src: url, style: { width: '50%' }, alt: 'uploaded' }), _jsx("p", __assign({ style: { visibility: 'hidden' } }, { children: props.children }))] }));
}
/*
