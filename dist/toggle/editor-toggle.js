...
var EditorToggle = /** @class */ (function (_super) {
    ...
    EditorToggle.prototype.render = function () {
        ...
        return (_jsx("div", __assign({ className: "inline-toggle text-editor-toggle ".concat(active) }, { children: _jsx("button", __assign({ onMouseDown: this.toggleStyle, onClick: this.onClick }, { children: this.props.children })) })));
    };
