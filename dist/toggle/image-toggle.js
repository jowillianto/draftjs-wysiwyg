...
var EditorImageToggle = /** @class */ (function (_super) {
    ...
    EditorImageToggle.prototype.render = function () {
        return (_jsxs("div", __assign({ className: 'img-toggle text-editor-toggle' }, { children: [_jsx("button", __assign({ onMouseDown: this.toggleDropDown, onClick: this.onClick }, { children: this.props.children })), this.state.dropDown &&
                    _jsx("div", __assign({ className: 'upload-bg' }, { children: _jsxs("div", __assign({ className: 'img-toggle-dropdown text-editor-toggle upload-msgbox' }, { children: [_jsx("div", __assign({ className: 'img-toggle-upload' }, { children: _jsx("input", { type: 'file', onChange: this.uploadFile }) })), _jsxs("div", __assign({ className: 'upload-btns' }, { children: [_jsx("button", __assign({ onClick: this.onClick, onMouseDown: this.toggleDropDown }, { children: "Cancel" })), _jsx("button", __assign({ className: 'img-toggle-add', onMouseDown: this.addImage, onClick: this.onClick }, { children: _jsx("p", { children: "Add" }) }))] }))] })) }))] })));
    };
